...
- complexity-analysis (medium): 2 unresolved signal(s), 3 coach event(s), tasks: build-product-id-index, compare-product-snapshots
...
- unique-event-attendees: data-transformation / build-from-requirements / easy; shape=first-occurrence-deduplication; status=reviewed; mastery=4
...
- Total tasks: 12
- Categories: algorithms=2, api-integration=1, async=2, data-transformation=3, performance=0, react=2, testing=0, typescript=2
- Task types: build-from-requirements=4, complete-partial-implementation=2, fix-bug=5, model-types=1
